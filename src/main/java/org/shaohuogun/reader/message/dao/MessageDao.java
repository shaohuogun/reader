...
public class MessageDao {
	...
	public void insert(Message message) {
		sqlSession.insert("org.shaohuogun.reader.message.dao.MessageMapper.insert", message);
	}

	public List<Message> selectAll() {
		return sqlSession.selectList("org.shaohuogun.reader.message.dao.MessageMapper.selectAll");
	}

	public Message selectById(String id) {
		return sqlSession.selectOne("org.shaohuogun.reader.message.dao.MessageMapper.selectById", id);
	}
	...
	public void update(Message message) {
		sqlSession.update("org.shaohuogun.reader.message.dao.MessageMapper.update", message);
	}

	public Message selectByPickingStatus(String pickingStatus) {
		return sqlSession.selectOne("org.shaohuogun.reader.message.dao.MessageMapper.selectByPickingStatus", pickingStatus);
	}

	public Message selectByPickingBatchNo(String pickingBatchNo) {
		return sqlSession.selectOne("org.shaohuogun.reader.message.dao.MessageMapper.selectByPickingBatchNo", pickingBatchNo);
	}
}